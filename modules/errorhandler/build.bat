...
rem Normal version
..\exec\asm68k /k /m /o c+ /o ws+ /o op+ /o os+ /o ow+ /o oz+ /o oaq+ /o osq+ /o omq+ /p /o ae- ErrorHandler.asm, ErrorHandler.bin, , ErrorHandler.lst
...
rem "External Symbol Table" version
..\exec\asm68k /k /m /o c+ /e _USE_SYMBOL_DATA_REF_=1 /e SymbolData_Ptr=0 /o ws+ /o op+ /o os+ /o ow+ /o oz+ /o oaq+ /o osq+ /o omq+ /p /o ae- ErrorHandler.asm, ErrorHandler.ExtSymbols.bin, ErrorHandler.ExtSymbols.sym, ErrorHandler.ExtSymbols.lst
...
rem Debug version
..\exec\asm68k /k /e __DEBUG__ /m /o c+ /o ws+ /o op+ /o os+ /o ow+ /o oz+ /o oaq+ /o osq+ /o omq+ /p /o ae- ErrorHandler.asm, ErrorHandler.Debug.bin, , ErrorHandler.Debug.lst
