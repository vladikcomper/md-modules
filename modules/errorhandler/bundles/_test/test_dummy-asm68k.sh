#!/bin/sh
wine ../../../exec/asm68k /k /m /o ws+ /o op+ /o os+ /o ow+ /o oz+ /o oaq+ /o osq+ /o omq+ /p /o ae- test_dummy-asm68k.asm, test_dummy-asm68k.gen, test_dummy-asm68k.sym, test_dummy-asm68k.lst
