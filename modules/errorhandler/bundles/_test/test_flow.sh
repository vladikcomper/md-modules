#!/bin/sh
../../../exec/cbundle test_flow

echo --- Building ASM68K version ---
wine ../../../exec/asm68k /k /m /o ws+ /o op+ /o os+ /o ow+ /o oz+ /o oaq+ /o osq+ /o omq+ /p /o ae- test_flow-asm68k.asm, test_flow-asm68k.gen, test_flow-asm68k.sym, test_flow-asm68k.lst
...
set USEANSI=n
wine ../../../exec/as/asl -xx -A -L test_flow-as.asm
wine ../../../exec/as/p2bin test_flow-as.p test_flow-as.gen -r 0x-0x
rm test_flow-as.p
