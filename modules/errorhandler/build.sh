...
wine ../exec/asm68k.exe /k /e _USE_SYMBOL_DATA_REF_=1 /e SymbolData_Ptr=0 /m /o ws+ /o op+ /o os+ /o ow+ /o oz+ /o oaq+ /o osq+ /o omq+ /p /o ae- ErrorHandler.asm, ErrorHandler.ExtSymbols.bin, ErrorHandler.ExtSymbols.sym, ErrorHandler.ExtSymbols.lst
